  ...
  return (
    <div className="flex flex-row border-b-1 w-full fixed z-10 justify-center bg-white dark:bg-[rgb(16,23,42)]">
      ...
      <div className="flex justify-start items-start">
       ...
       <img alt="coderxyz" src="https://firebasestorage.googleapis.com/v0/b/adhyatma-ce6a3.appspot.com/o/1735566563733_coderxyz.png?alt=media&token=aa59cda9-b542-469f-9a36-9c73c87502e2" className="md:w-36"  />
        </Link>
      </div>
